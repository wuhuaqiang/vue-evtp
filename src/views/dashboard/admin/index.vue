...
export default {
  data() {
    return {
      ...
      car_xycdIcon: {
        url: car_xycdImg, // http://10.168.1.235:8088/api/images/car_xycd.gif
        size: { width: 18, height: 18 },
        opts: {
          anchor: { width: 0, height: 0 },
          imageOffset: { width: 0, height: 0 },
      ...
      car_xyjyIcon: {
        url: car_xyjyImg, // http://10.168.1.235:8088/api/images/car_xyjy.gif
        size: { width: 18, height: 18 },
        opts: {
          anchor: { width: 0, height: 0 },
          imageOffset: { width: 0, height: 0 },
      ...
      car_zzcdIcon: {
        url: car_zzcdImg, // http://10.168.1.235:8088/api/images/car_xyjy.gif
        size: { width: 18, height: 18 },
        opts: {
          anchor: { width: 0, height: 0 },
          imageOffset: { width: 0, height: 0 },
      ...
      stationIcon: {
        url: stationImg, // http://10.168.1.235:8088/api/images/chargingStation.png
  ...
  created() {
    ...
    if ('WebSocket' in window) {
      this.websocket = new WebSocket('ws://localhost:2004/websocket')
      // 连接发生错误的回调方法
  ...
  methods: {
    ...
    addKLineTu() {
      const this_ = this
      axios.get('http://10.168.1.235:8088/api/images/stock-DJI.json').then((rawData) => {
    ...
    addZlineTu() {
      axios.get('http://10.168.1.235:8088/api/images/aqi-beijing.json').then(result => {
