<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-button :loading="loading" type="info" style="width:40%;margin-bottom:30px;float: right" @click.native.prevent="handleRegister">注册</el-button>
      <!--</el-form-item>-->
    ...
    <el-dialog :title="'注册'" :visible.sync="dialogFormVisible" width="40%">
      <el-form ref="dataForm" :model="loginForm" label-position="right" label-width="80">
        ...
        <el-form-item prop="password" size="small" :label="'密码'" style="background: #7d7d7f">
          <span class="svg-container">
            <svg-icon icon-class="password" />
          </span>
          <el-input
...
<style lang="scss">
/* 修复input 背景不协调 和光标变色 */
/* Detail see https://github.com/PanJiaChen/vue-evtp/pull/927 */
