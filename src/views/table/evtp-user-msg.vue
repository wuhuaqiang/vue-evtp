<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="'电动汽车ID'" align="center">
        <template slot-scope="{row}">
          <el-tag>
            {{ row.evId }}
          </el-tag>
      ...
      <el-table-column :label="'用户家ID'" align="center">
        <template slot-scope="{row}">
          <el-tag>
            {{ row.homePositionId }}
          </el-tag>
      ...
      <el-table-column :label="'用户公司ID'" align="center">
        <template slot-scope="{row}">
          <el-tag>
            {{ row.companyPositionId }}
          </el-tag>
        </template>
      </el-table-column>
      <el-table-column :label="'用户TaskID'" align="center">
        <template slot-scope="{row}">
          <el-tag>
            {{ row.otherPositionId }}
          </el-tag>
...
<script>
import { saveOrUpdateUser, queryPage } from '@/api/evtpUser'
